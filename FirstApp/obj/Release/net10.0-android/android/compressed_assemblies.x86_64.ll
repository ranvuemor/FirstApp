...
@compressed_assembly_descriptors = dso_local local_unnamed_addr global [122 x %struct.CompressedAssemblyDescriptor] [
	...
	%struct.CompressedAssemblyDescriptor {
		...
		i1 false, ; bool loaded
		i32 12005768; uint32_t buffer_offset
	}, ; 119: Java.Interop
	%struct.CompressedAssemblyDescriptor {
		i32 22560, ; uint32_t uncompressed_file_size
		i1 false, ; bool loaded
		i32 12176776; uint32_t buffer_offset
	}, ; 120: Mono.Android.Runtime
	%struct.CompressedAssemblyDescriptor {
		i32 2022400, ; uint32_t uncompressed_file_size
		i1 false, ; bool loaded
		i32 12199336; uint32_t buffer_offset
	} ; 121: Mono.Android
], align 16

@uncompressed_assemblies_data_size = dso_local local_unnamed_addr constant i32 14221736, align 4

@uncompressed_assemblies_data_buffer = dso_local local_unnamed_addr global [14221736 x i8] zeroinitializer, align 16
