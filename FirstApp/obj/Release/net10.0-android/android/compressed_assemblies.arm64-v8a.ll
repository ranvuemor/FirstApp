...
@compressed_assembly_descriptors = dso_local local_unnamed_addr global [123 x %struct.CompressedAssemblyDescriptor] [
	...
	%struct.CompressedAssemblyDescriptor {
		...
		i1 false, ; bool loaded
		i32 12053384; uint32_t buffer_offset
	}, ; 120: Java.Interop
	%struct.CompressedAssemblyDescriptor {
		i32 22560, ; uint32_t uncompressed_file_size
		i1 false, ; bool loaded
		i32 12224392; uint32_t buffer_offset
	}, ; 121: Mono.Android.Runtime
	%struct.CompressedAssemblyDescriptor {
		i32 2019840, ; uint32_t uncompressed_file_size
		i1 false, ; bool loaded
		i32 12246952; uint32_t buffer_offset
	} ; 122: Mono.Android
], align 4

@uncompressed_assemblies_data_size = dso_local local_unnamed_addr constant i32 14266792, align 4

@uncompressed_assemblies_data_buffer = dso_local local_unnamed_addr global [14266792 x i8] zeroinitializer, align 1
